...
let change_ani = document.getElementById("change_ani")
let change_ani_before = window.getComputedStyle(change_ani,'::before')
// console.log(change_ani_before.animationName);
...
function startbtn() {
    ...
    change_ani.style.setProperty('--before', "ani")
...
function stopbtn(){
    ...
    document.getElementById("lightBulb3").style.backgroundColor = "#c2c2c2";
    document.getElementById("lightBulb3").style.boxShadow = "none"
    change_ani.style.setProperty('--before',  " ")
